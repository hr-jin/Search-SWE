...
**Task:** `task-1-x` · **Mode:** Implementation · **Metric:** MemoryAnswerAccuracy
...
```bash
python scripts/download_assets.py --task-path task-submissions/haoran/1-x
bash scripts/run_task.sh --task-path task-submissions/haoran/1-x --model "YOUR_AGENT_MODEL"
```
